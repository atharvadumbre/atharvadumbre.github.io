...
const Social = () => {
  return (
    <div className="home__social">
        <a href="https://www.linkedin.com/in/atharvadumbre/" className="home__social-icon" target="_blank">
            <i className='uil uil-linkedin'></i>
        </a>

        <a href="https://github.com/atharvadumbre" className="home__social-icon" target="_blank">
        <i className='uil uil-github-alt'></i>
        </a>

        <a href="https://www.kaggle.com/atharvadumbre" className="home__social-icon" target="_blank">
