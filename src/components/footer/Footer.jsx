    ...
    <footer className="footer">
        <div className="footer__container container">
            ...
            <div className="footer__social">
                <a href="https://www.linkedin.com/in/atharvadumbre/" className="footer__social-link" target="_blank">
                <i className='uil uil-linkedin'></i>
                </a>

                

                <a href="https://www.kaggle.com/atharvadumbre" className="footer__social-link" target="_blank">
                ...
                <a href="https://github.com/atharvadumbre" className="footer__social-link" target="_blank">
