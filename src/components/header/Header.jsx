  ...
  return (
    <header className='header'>
      <nav className='nav container'>
        <a href="index.html" className='nav__logo'>Atharva Dumbre</a>
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className='nav__list grid'>
            ...
            <li className="nav__item">
              ...
              className={activeNav === '#certificates' ? "nav__link active-link" : 
              "nav__link"}>
                <i className="uil uil-file nav__icon"></i>Certificates
              </a>
            </li>
