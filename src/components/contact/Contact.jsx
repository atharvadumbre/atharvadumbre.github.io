...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_m2kbqrc', 'template_pny6f9h', form.current, {
        publicKey: 'WIbgGv9KoLhhRj-5p',
      })
      e.target.reset()
  };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <a href="mailto:atharva.dumbre1@gmail.com" className="contact__button">Write to me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    {/* <div className="contact__card">
                        ...
                        <a href="insert something here idk wtf" className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div> */}
